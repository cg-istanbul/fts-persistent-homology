# examples/real/coil20_n1000.sage
...
X_path = os.path.join(ROOT, "data", "coil20", "coil20_n1000.csv")
M_path = os.path.join(ROOT, "data", "coil20", "coil20_n1000_meta.csv")

X = np.loadtxt(X_path, delimiter=",")
n, d = X.shape
print("Loaded COIL-20 n=1000: n = {}, dim = {}".format(n, d))

# Optional meta (not needed for filtration)
meta = None
if os.path.exists(M_path):
    try:
        meta = np.loadtxt(M_path, dtype=str, delimiter=",", skiprows=1)
        print("Loaded meta rows: {}".format(len(meta)))
    except Exception as e:
        print("Failed to load meta: {}".format(e))
